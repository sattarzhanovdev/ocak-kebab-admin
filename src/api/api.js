...
export const getSuccessOrders = () => axios.get(`${ACCESS_URL}${requestPath.successOrder}.json`)
export const postSuccessOrders = (data) => axios.post(`${ACCESS_URL}${requestPath.successOrder}.json`, data)